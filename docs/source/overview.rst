...
The user provides one or more functions (models) and corresponding datasets to be fitted by their model by adjusting specified parameters to minimize the total :math:`\chi^2` across all datasets.
...
.. autoclass:: frankford.Fitter
    :members: __init__, __call__, ftol, xtol, gtol, stepfactor, covtol, maxiter, douserscale, parameters, models
